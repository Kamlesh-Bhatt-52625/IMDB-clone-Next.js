...
const About = () => {
  return (
    <div className="max-w-6xl mx-auto p-3 space-y-4">
      <h1 className="text-2xl font-medium text-[#f5c518]">About Us</h1>
      <p>
      ...
      <p>
        ...
        <Link
          ...
          target="_blank"
          className="text-[#f5c518] cursor-pointer underline underline-offset-2"
        >
          contact
        </Link>{" "}
        us. We are always looking for ways to improve and enhance the user
